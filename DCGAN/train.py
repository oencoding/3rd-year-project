...
def train_model(train_data):
    ...
    while not done:
        ...
        summary,_, _, gene_loss, disc_real_loss, disc_fake_loss = td.sess.run([summaries,td.gene_minimize, td.disc_minimize, td.gene_loss, td.disc_real_loss, td.disc_fake_loss], feed_dict=feed_dict)
        ...
        if batch % FLAGS.summary_period == 0:
            # Show progress with test features,summary_period=10
